...
module.exports = {
    ...
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            {
                key: `${keyPrefix}hired`,
                label: `Candidate hired status`,
                type: 'boolean',
                ...(isInput && { helpText: "Whether the candidate has been hired." }),
            },
            {
            ...
            {
                key: `${keyPrefix}short_listed`,
                label: `Candidate short-listed status`,
                type: 'boolean',
                ...(isInput && { helpText: "Whether the candidate has been short-listed." }),
            },
            {
            ...
            {
                key: `${keyPrefix}communications`,
                label: `Candidate communications`,
                type: 'string',
                ...(isInput && { helpText: "Communication tracking data for the candidate." }),
            },
            {
            ...
            {
                key: `${keyPrefix}kombo_application_id`,
                label: `Kombo Application ID`,
                type: 'string',
                ...(isInput && { helpText: "The Kombo application ID associated with this candidate." }),
            },
            {
                key: `${keyPrefix}tags`,
                ...
                type: 'string',
                list: true,
                ...(isInput && { helpText: "Tags associated with the candidate." }),
            },
            {
    ...
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'hired': bundle.inputData?.[`${keyPrefix}hired`],
            'language': bundle.inputData?.[`${keyPrefix}language`],
            'short_listed': bundle.inputData?.[`${keyPrefix}short_listed`],
            'invited_at': bundle.inputData?.[`${keyPrefix}invited_at`],
            'communications': bundle.inputData?.[`${keyPrefix}communications`],
            'completed_at': bundle.inputData?.[`${keyPrefix}completed_at`],
            'kombo_application_id': bundle.inputData?.[`${keyPrefix}kombo_application_id`],
